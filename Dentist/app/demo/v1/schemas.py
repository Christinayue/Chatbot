...
definitions = {'definitions': {'Dentist': {'type': 'object', 'properties': {'name': {'type': 'string'}, 'phone': {'type': 'integer'}, 'location': {'type': 'string'}, 'specializaton': {'type': 'string'}, 'time': {'type': 'string'}}}}, 'parameters': {}}

validators = {
    ('dentists', 'POST'): {'json': {'$ref': '#/definitions/Dentist'}},
}

filters = {
    ('dentists', 'GET'): {200: {'headers': None, 'schema': {'type': 'array', 'items': {'$ref': '#/definitions/Dentist'}}}, 400: {'headers': None, 'schema': None}},
    ('dentists', 'POST'): {200: {'headers': None, 'schema': {'$ref': '#/definitions/Dentist'}}, 400: {'headers': None, 'schema': None}},
    ('dentists_name', 'GET'): {200: {'headers': None, 'schema': {'$ref': '#/definitions/Dentist'}}, 400: {'headers': None, 'schema': None}, 404: {'headers': None, 'schema': None}},
}
